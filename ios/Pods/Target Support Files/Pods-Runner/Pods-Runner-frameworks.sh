...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/audio_waveforms/audio_waveforms.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/launch_review/launch_review.framework"
