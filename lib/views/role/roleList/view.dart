...
class RoleListPage extends StatelessWidget {
  ...
  Widget _customContainer (){
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(10.w), // Optional: for rounded corners
      ),
      child: Container(
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/icons/customRole.png',width: 32.w,height: 28.w,fit: BoxFit.cover,),
            ),
            Column(
  ...
  Widget _roleItem(index) {
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: index%3 ==0 ? const LinearGradient(
          colors: [Color.fromRGBO(217, 78, 255, 1),Color.fromRGBO(255, 202, 71, 1)],
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Row(
                    children:[
                      Image.asset('assets/images/icons/heart.png',width: 18.w,height: 16.w,fit: BoxFit.cover,),
